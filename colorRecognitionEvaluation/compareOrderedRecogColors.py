...
def main():
    ...
    with open(r'C:\Users\jiali\Desktop\choroColorRead\colorRecognitionEvaluation' + '\\' + 'colorsOrderedImagesRemoveGrey1.pickle', 'rb') as f:
        colorsOrderedImages = pickle.load(f)
        # print(colorsOrdered)
    # for imageName in colorsOrderedImages.keys():
        # orderedColorList = colorsOrderedImages[imageName]
        # recognizedColorList = spColorExtraction[imageName][0] # 0: detected colors, 1: missed colors
        # if len(orderedColorList)!=len(recognizedColorList):
        #     print('imageName: ' + imageName)
        #     print(orderedColorList)
        #     # print(recognizedColorList)
    colorsOrderedImages['us_Blues_8_pos_large1.jpg'] = colorsOrderedImages['us_Blues_8_pos_large1.jpg'][1:]

    with open(r'C:\Users\jiali\Desktop\choroColorRead\colorRecognitionEvaluation' + '\\' + 'colorsOrderedImagesRemoveGrey3.pickle', 'wb') as f:
