...
def main():
    ...
    rootPath = r'C:\Users' + computerName + '\Desktop\choroColorRead'
    savePath = rootPath +'\generatedMapsSuperPixels\quantiles'
    path =  rootPath +'\generatedMaps\quantiles'
    ...
    for i,imgName in enumerate(imageNames):
        ...
        fig.savefig(savePath + '\\' + 'sp_300_' + imgName, bbox_inches='tight')
        imgNameShort = imgName.split('.')[:-1]
    with open('E:\\sp_challenging\\sp_300_spatialPattern_images_quantiles' + '.pickle', "wb") as f:
